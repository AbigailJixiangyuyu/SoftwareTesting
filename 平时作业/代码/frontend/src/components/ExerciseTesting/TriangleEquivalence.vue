<template>
    <div class="triangle_css">
      <p class="question">
        问题简介: 判断三角形类型（等价类方法分别分析和设计测试用例）。
      </p>
      <div style="display: flex; align-items: center;">
        <!-- 文件上传组件 -->
        <el-upload
          action="http://47.116.193.81:25690/test/triangle"
          multiple
      ...
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="a" label="三角形边a" width="100"></el-table-column>
        <el-table-column prop="b" label="三角形边b" width="100"></el-table-column>
        <el-table-column prop="c" label="三角形边c" width="100"></el-table-column>
